    ...
    Partial Class oilpo
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                txtPONo.Text = ExecuteQuery("select isnull(max(po_no),0)+1  from oilpo_master WHERE PO_fin_year='" & fin_year1.ToString() & "'")
        ...
        Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
            If hdnrwcnt.Value <> 0 Then
                ...
                Else
                    ...
                    cmd = New SqlCommand("ins_oilpomaster", Con)
                    ...
                    cmd.Parameters.AddWithValue("@Year1", txtYear)
                    ...
                    If strIndentdetails.ToString <> "" Then
                        ...
                        For i = 0 To myarray.Length - 1
                            If myarray(i) <> "" Then
                                ...
                                Dim strq As String = "get_oilitemcode '" & mainarray(0) & "' "
                                ...
                                cmd = New SqlCommand("Ins_oilPO_Details", Con)
                                cmd.CommandType = CommandType.StoredProcedure
                                cmd.Parameters.AddWithValue("@oilpoid", maxid)
                                cmd.Parameters.AddWithValue("@oilitem_code", Itemcode)
                                cmd.Parameters.AddWithValue("@ltrperbarrel", mainarray(1))
                                cmd.Parameters.AddWithValue("@noofbarrel", mainarray(2))
                                cmd.Parameters.AddWithValue("@totalltr", mainarray(3))
                                cmd.Parameters.AddWithValue("@perltrrate", mainarray(4))
                                cmd.Parameters.AddWithValue("@perbarrelrate", mainarray(5))
                                cmd.Parameters.AddWithValue("@amount", mainarray(6))
                    ...
                    If strdelschotr.ToString <> "" Then
                        ...
                        For y = 0 To mydelschotr.Length - 1
                            If mydelschotr(y) <> "" Then
                                ...
                                cmd = New SqlCommand("ins_oil_schedule_new", Con)
                                cmd.CommandType = CommandType.StoredProcedure
                                cmd.Parameters.AddWithValue("@oil_po_id", maxid)
                        ...
                        Next
                    End If
                    Response.Write("<script>alert('Saved Successfuly');if(confirm('Do You Want To Print PO')){window.location.href = '../fuel/rptoilpo.aspx?PoNo=" + txtPONo.Text + "&poyear=" + fin_year + "&vendor=" + ddlvendor.Text + "' }</script>")
        ...
        Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
            Response.Write("<script>window.location.href = '../fuel/rptoilPO.aspx'</script>")
        End Sub
    End Class
End Namespace
