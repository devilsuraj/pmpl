        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(../assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="../assets/global/img/logo-main.png" /> </div>
                </div>
          ...
          <asp:ListItem Text="Fuel Section" Value="4" ></asp:ListItem>
            ...
            <div class="login-div" action="index.html" method="post" novalidate>
               <h3 class="form-title font-blue text-center">
                ...
                <div class="form-group">
                    ...
                    <input name="txtusername" type="text" class="form-control form-control-solid placeholder-no-fix" id="txtusername" runat="server"> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                   <input name="txtpass" type="password" class="form-control form-control-solid placeholder-no-fix" id="txtpass" runat="server"> </div>
