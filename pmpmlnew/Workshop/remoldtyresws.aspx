<%@ Page Language="VB" AutoEventWireup="false" CodeFile="remoldtyresws.aspx.vb" Inherits="KDMT.remoldtyresws" %>
                                                            ...
                                                            <tr>
                                                                <asp:DataGrid ID="dgresult" Width="100%" CellPadding="4" CellSpacing="0" BorderColor="#FFFFFF"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="mfgyear">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtmfgyear" runat="server" MaxLength="4" Width="30px"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:BoundColumn DataField="Part_Company" HeaderText="Company Name"></asp:BoundColumn>
                                                                        <asp:TemplateColumn HeaderText="Plane Type">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="HOT COLD">
                                                                            <ItemTemplate>
