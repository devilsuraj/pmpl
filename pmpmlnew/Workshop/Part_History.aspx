<%@ Page Language="VB" EnableEventValidation="False" AutoEventWireup="false" CodeFile="Part_History.aspx.vb"
  ...
  <tr>
                ...
                <table width="100%" border="1" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtcompanyno" Style="width: 120px" class="textfield" name="txtcompanyno"
                                onblur="getWSNo();chktyrefittedbus();" runat="server"></asp:TextBox>
                            <asp:ListBox ID="Select1" Style="display: none; align: left" onclick="Select();"
                                runat="server"></asp:ListBox>
