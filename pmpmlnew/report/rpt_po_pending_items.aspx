<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_po_pending_items.aspx.vb" Inherits="KDMT.report_rpt_po_pending_items" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td valign="top" align="center">
                <strong><span style="font-size: 16pt; color: black">&nbsp;Pending PO Items Report</span></strong>
            </td>
        </tr>
        <tr>
            <td>
                ...
                From Date : <BDP:BDPLite ID="ddlfinancecalendar1" runat="server">
                </BDP:BDPLite>
                To Date :
                <BDP:BDPLite ID="ddlfinancecalendar2" runat="server">
                </BDP:BDPLite>
                ...
                <asp:Button ID="Button1" runat="server" Text="Crystal report" Visible=false />
            </td>
        </tr>
        </table>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            ...
            <td align="right" style="height: 19px" colspan="2">
                Year:-
                <asp:Label ID="lbltoyears" runat="server" Width="68px" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>            <td colspan="4" align="left" style="height: 50px">
                <div align="center">
                    <asp:DataGrid ID="grdstock" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="po_no" HeaderText="PO NO" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width=80px></asp:BoundColumn>                            
                            <asp:BoundColumn DataField="po_date" HeaderText="PO Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>     
                                ...
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>                            
                                <asp:BoundColumn DataField="contact_no" HeaderText="Contact No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>                            
                        </Columns>
                    </asp:DataGrid>
                </div>
