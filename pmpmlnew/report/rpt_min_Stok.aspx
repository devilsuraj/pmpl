<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_min_Stok.aspx.vb" Inherits="KDMT.rpt_min_Stok" %>
...
<body class="body">
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px" colspan="4">
                <strong><span style="font-size: 11pt; color: black">Minimum Stock Level Report &nbsp;</span></strong>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:DropDownList ID="ddlresulttype" runat="server">
                    ...
                    <asp:ListItem Text="Zero Balance" Value="71"></asp:ListItem>
                    <asp:ListItem Text="Non Zero Balance" Value="72"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <%--<tr>
    ...
    <div id="crydv" runat="server">
        <CR:CrystalReportViewer ID="crst_min_stock" runat="server" AutoDataBind="true" />
    </div>
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Minimum Stock Level Report </span></strong>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="file_number" HeaderText="File Number" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="PO No" ItemStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <a href='purchase_request_report.aspx?fileno=<%# DataBinder.Eval(Container, "DataItem.file_number") %>'>
                                        <font color="Blue"></font>
                                        <%#DataBinder.Eval(Container, "DataItem.itemfile_name")%></a>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:BoundColumn DataField="consumption" HeaderText="consumption" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="min_stock_lvl" HeaderText="Min Stock Level" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="shortage" HeaderText="Shortage" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
