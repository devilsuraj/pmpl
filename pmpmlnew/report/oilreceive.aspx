<%@ Page Language="VB" AutoEventWireup="false" CodeFile="oilreceive.aspx.vb" Inherits="KDMT.oilreceive" %>
												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<TR>
														<TD class="text3" align="center" style="height: 32px">
                                                            <strong><span style="font-size: 15pt; color: #0033ff">Oil Report<br />
                                                                <br />
                                                                <br />
                                                                <br />
                                                                <br />
