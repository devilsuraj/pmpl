...
Namespace KDMT
    ...
    Partial Class report_rptreceiptcontrolreport_YEAR
        ...
        Protected Sub btnshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnshow.Click
            Try
                ...
                BindGrid(grdstock, con, "VIEW_receipt_Control_Detail_NEW '" & ddlparttype.SelectedValue & "','" & fromdate & "','" & todate & "'")
        ...
        Protected Sub grdstock_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grdstock.ItemDataBound
            Select Case e.Item.ItemType
                Case ListItemType.AlternatingItem, ListItemType.Item
                    ...
                    TotalItem1 = TotalItem1 + CDbl(e.Item.Cells(8).Text)
                Case ListItemType.Footer
                    e.Item.Cells(3).Text = "Grand Total : "
                    e.Item.Cells(6).Text = TotalItem.ToString()
                    e.Item.Cells(8).Text = TotalItem1.ToString()
            End Select
        End Sub
    End Class
End Namespace
