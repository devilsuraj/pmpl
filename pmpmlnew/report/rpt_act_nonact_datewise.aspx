<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_act_nonact_datewise.aspx.vb" Inherits="KDMT.report_rpt_act_nonact_datewise" %>
...
<head>
    <title>Active Non-Active Summery Report</title>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px" colspan="4">
                <strong><span style="font-size: 11pt; color: black">Active Non Active Report &nbsp;</span></strong>
            </td>
        </tr>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Active Non Active Report </span></strong>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="actitem" HeaderText="Active Items" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="nonactive" HeaderText="Non Active Items" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>                  
                           <asp:BoundColumn DataField="totalitems" HeaderText="Total Items " ItemStyle-HorizontalAlign="left"
