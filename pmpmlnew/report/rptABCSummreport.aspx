<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptABCSummreport.aspx.vb"
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">ABC Report</span></strong>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="ItemTotal" HeaderText="Item Count" FooterText="100%"
                                ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="right">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ItemPer" HeaderText="%" FooterText="100%" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="right"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ConTotal" HeaderText="AC Value(Rs.)" FooterText="100%"
                                ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="right">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ConPer" HeaderText="%" FooterText="100%" ItemStyle-HorizontalAlign="right"
