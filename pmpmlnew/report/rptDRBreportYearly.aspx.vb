...
Imports System.IO
Namespace KDMT
    Partial Class report_rptDRBreportYearly
        ...
        Protected Sub grdstock_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grdstock.ItemDataBound
            ...
            Select Case e.Item.ItemType
                Case ListItemType.AlternatingItem, ListItemType.Item
                    ...
                    TotalItem1 = TotalItem1 + CDbl(e.Item.Cells(6).Text)
                Case ListItemType.Footer
                    e.Item.Cells(1).Text = "Grand Total : "
                    e.Item.Cells(4).Text = TotalItem.ToString()
                    e.Item.Cells(6).Text = TotalItem1.ToString()
            End Select
            'Select Case e.Item.ItemType
            '    Case ListItemType.AlternatingItem, ListItemType.Item
            '        TotalItem1 = TotalItem1 + CDbl(e.Item.Cells(6).Text)
        ...
        Protected Sub btnshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnshow.Click
            Try
                ...
                'Next
                BindGrid(grdstock, con, "view_battery_detail '" & ddldepttype.SelectedValue & "','" & ddldrbtype.SelectedValue & "','" & fromdate & "','" & todate & "','" & txtvendor.Value & "'")
                'BindGrid(grdstock, con, "VIEW_cont_receive_report_Yearly '" & ddldepttype.SelectedValue & "','" & ddldrbtype.SelectedValue & "','" & ddlrecyear.SelectedItem.Text & "'")
        ...
        Protected Sub ddldepttype_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddldepttype.SelectedIndexChanged
            ...
            Else
                ...
                ddldrbtype.Items.Add(New ListItem("Battery", "Battery"))
                ddldrbtype.Items.Add(New ListItem("Tyre", "Tyre"))
            End If
        End Sub
    End Class
End Namespace
