<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_act_nonact.aspx.vb"
    Inherits="KDMT.rpt_act_nonact" %>
...
<html>
<head>
    <title>Active Non-Active Report</title>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlmoving" runat="server">
                    <asp:ListItem Text="Active" Value="5"></asp:ListItem>
                    <asp:ListItem Text="Non Active" Value="6"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <%--<tr>
                    ...
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="rate" HeaderText="Rate" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="stock_value" HeaderText="Stock Value" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
