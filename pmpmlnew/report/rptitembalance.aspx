<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptitembalance.aspx.vb"
    Inherits="KDMT.rptitembalance" %>
...
<body class="body">
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 700px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px">
                <strong><span style="font-size: 11pt; color: black">Item Balance Report &nbsp;</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div id="divcryrpt" runat ="server">
        <CR:CrystalReportViewer ID="crst_item_bal" runat="server" AutoDataBind="true" 
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="q" HeaderText="Balance" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center">                          
                            </asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
