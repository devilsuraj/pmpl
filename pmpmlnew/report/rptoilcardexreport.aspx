<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptoilcardexreport.aspx.vb"
    Inherits="KDMT.report_rptoilcardexreport" %>
...
//else
//{
    url = "../store/AjaxStore.aspx?Action=oilitemname&itemid=''&item=" + document.getElementById ('ddlitem').value ;   
    xmlHttp.open("GET",url ,true);
    xmlHttp.send(null);
//}
}
...
<body class="body">
    ...
    <table id="Table1" style="width: 750px" align="center" cellspacing="0" cellpadding="0"
        runat="server" class="ctrl" border="1">
        <tr style="height: 50px">
            <td class="text3" align="center" style="height: 22px" colspan="2">
                <strong><span style="font-size: 11pt; color: black">Oil Cardex Report</span></strong>
            </td>
        </tr>
        <tr>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4" style="height: 30px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Width="224px">Oil Cardex Report</asp:Label>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="oilrefno" HeaderText="Ref No" HeaderStyle-HorizontalAlign="Center">
                            </asp:BoundColumn>
