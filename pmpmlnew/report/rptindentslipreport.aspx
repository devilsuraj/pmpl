<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptindentslipreport.aspx.vb"
    Inherits="KDMT.rptindentslipreport" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td valign="top" align="center" colspan="2">
                <strong><span style="font-size: 16pt; color: black">Indent Slip Report</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Indent Slip Report</span></strong>
            </td>
        </tr>
        <tr>
