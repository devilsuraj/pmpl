<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_fsm_pendingpo.aspx.vb"
    Inherits="KDMT.rpt_fsm_pendingpo" %>
...
<body class="body">
    ...
    <div id="divcry" runat="server">
        <CR:CrystalReportViewer ID="crt_fsm" runat="server" AutoDataBind="true" />
    </div>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn ItemStyle-Width="150" DataField="bin_no" HeaderText="Bin No"
                            ...
                            <%--<asp:BoundColumn DataField="item_qty" HeaderText="Order Qty" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                            <asp:BoundColumn ItemStyle-Width="150" DataField="balance" HeaderText="Stock Quantity"
                            ...
                            <asp:BoundColumn ItemStyle-Width="300" DataField="file_po_type" HeaderText="PO No" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>
