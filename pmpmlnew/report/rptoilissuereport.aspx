<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptoilissuereport.aspx.vb" Inherits="KDMT.report_rptoilissuereport" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td valign="top" align="center">
                <strong><span style="font-size: 16pt; color: black">Oil Issued Report</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Oil Issued Report</span></strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" align="left" style="height: 50px">
                <div align="center">
                    ...
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                          <asp:TemplateColumn HeaderText="Sr No.">
                           ...
                           <asp:BoundColumn DataField="oilrefno" HeaderText="Indent No" HeaderStyle-HorizontalAlign="Center">
                            </asp:BoundColumn>
                 ...
                 <asp:BoundColumn DataField="issueltrperbarrel" HeaderText="Ltr Per Barrel" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                 <asp:BoundColumn DataField="issuebarrel" HeaderText="Issue Barrel" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                
                                
                            <asp:BoundColumn DataField="Quantity" HeaderText="Total Quantity" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
