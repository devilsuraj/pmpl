<%@ Page Language="VB" AutoEventWireup="false" CodeFile="recooperation.aspx.vb" Inherits="KDMT.recooperation" %>
...
<body class="body">
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px" colspan="2">
                <strong><span style="font-size: 11pt; color: black">Recoupment Report &nbsp;</span></strong>
            </td>
        </tr>
        <tr>
            <td align="left">
    ...
    <div id="divcry" runat ="server" >
        <CR:CrystalReportViewer ID="crst_min_coop" runat="server" AutoDataBind="true" />
    </div>
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Recoupment Report </span></strong>
            </td>
        </tr>
        <tr>
            <td align="Center" colspan="4">
        ...
        <tr>
            <td align="left" style="height: 19px" colspan="2">
                ...
                <asp:Label ID="lblcurrent" runat="server" Width="168px" Font-Bold="True"></asp:Label>
            </td>
            <td align="right" style="height: 19px" colspan="2">
                <asp:Label ID="Label5" runat="server" Width="168px" Font-Bold="True"></asp:Label>
                
                <asp:Label ID="lbllast_consunp" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="PO" HeaderText="PO" ItemStyle-HorizontalAlign="left"
                            ...
                            <asp:BoundColumn DataField="item_qty" HeaderText="Order Qty" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="receive_qty" HeaderText="Receive Qty" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="pen_qty" HeaderText="Balance Qty" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
