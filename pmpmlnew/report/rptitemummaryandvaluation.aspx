<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptitemummaryandvaluation.aspx.vb"
    Inherits="KDMT.rptitemummaryandvaluation" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td valign="top" align="center">
                <strong><span style="font-size: 16pt; color: black">Item Summary and Valuation Report</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Item Summary and Valuation Report</span></strong>
            </td>
        </tr>
        <tr>
