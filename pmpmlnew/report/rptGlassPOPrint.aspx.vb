    ...
    Partial Class rptGlassPOPrint
        ...
        Private Sub showdata(ByVal category As Integer, ByVal potype As String, ByVal pono As Integer, ByVal poyear As String, ByVal vendor As String)
            Try
                ...
                cmd = New SqlCommand("view_po_details_GlassPO '1','" & category & "','" & potype & "','" & pono & "','" & poyear & "','" & vendor & "'", con)
                ...
                If dt.Rows.Count <> 0 Then
                    ...
                    Try
                        If con.State = ConnectionState.Closed Then
                            con.Open()
                        End If
                        Dim da As New SqlClient.SqlDataAdapter("view_po_details_GlassPO '2'," & drpType.SelectedValue & "," & drbPoType.SelectedValue & ",'" & txtPONo.Text & "','" & ddlfinancecalendar.SelectedItem.Text & "','" & txtvendor.Text & "'", con)
                        ...
                        If (ds_tics.Tables(0).Rows.Count > 0) Then
                            ...
                            For i = 0 To ds_tics.Tables(0).Rows.Count - 1
                                Dim cell3, cell4, cell5, cell6, cell7, style, style1 As String
                                ...
                                If i = 14 Or ((i = ds_tics.Tables(0).Rows.Count - 1) And i < 14) Then
                                    ...
                                    If (ds_poschedule.Tables(0).Rows.Count > 0) Then
                                        ...
                                        For s = 0 To ds_poschedule.Tables(0).Rows.Count - 1
                                            Dim cellc1, cellc2, cellc3, styles, styles1 As String
                                            ...
                                            If ctr1 = 0 Then
                                                ...
                                                'If ddlprint.SelectedItem.Text <> "ORIGINAL" Then
                                                '    html += "<td align='right' " + styles1 + ">" + " No" + "</td>"
                                                '    html += "<td align='center'" + styles1 + ">" + " No" + "</td>"
                                                'End If
                                                html += "<td align='Center' " + styles1 + " colspan='3'>" + "Item No" + "</td>"
                                                html += "<td align='Center' " + styles1 + " colspan='2'>" + "Stock Quantity" + "</td>"
                                                html += "<td align='Center' " + styles1 + " colspan='3'>" + "Month" + "</td>"
                                                'html += "<td align='right' " + styles1 + ">" + "Unit" + "</td>"
                                                'html += "<td align='right' " + styles1 + ">" + "Rate" + "</td>"
                                                'html += "<td align='right' " + styles1 + ">" + "Amount Rs" + "</td>"
                                            ...
                                            'html += "<td align='left' " + styles + ">" + cellc4 + "</td>"
                                            'html += "<td align='right' " + styles + ">" + cellc5 + "</td>"
                                            'html += "<td align='right' " + styles + ">" + cell8 + "</td>"
                                            'html += "<td align='right' " + styles + ">" + cell6 + "</td>"
                                            'html += "<td align='right' " + styles + ">" + cell7 + "</td>"
