<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllClaimReport.aspx.vb" Inherits="KDMT.report_AllClaimReport" %>
...
<html>
<head>
    <title>RECEIPT CLAIM REPORT</title>
...
//-->
    ...
    <table id="Table1" align="center" border="1" style="width: 100%" runat="server">
                    ...
                    <asp:DataGrid ID="grdstock" Style="align:center; valign:middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Sr No.">
                             ...
                             <asp:BoundColumn DataField="vendor_name" HeaderText="Vendor Name" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="90">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="Item_Name" ItemStyle-HorizontalAlign="left" HeaderText="Item Description"
                            ...
                            <asp:BoundColumn DataField="Part_No" HeaderText="Part No" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50"></asp:BoundColumn>
                            
                            <asp:BoundColumn DataField="claimno" HeaderText="Claim No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="30">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="claimdate" HeaderText="Claim Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="challan_no" HeaderText="Challan No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="challan_date" HeaderText="Challan Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="po_no" HeaderText="Order No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="po_date" HeaderText="Order Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="rec_no" HeaderText="Rec No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="rec_date" HeaderText="Rec Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                            </asp:BoundColumn>    
                           <%--  
                            <asp:BoundColumn DataField="rack_no" HeaderText="LF No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="70"
                            ...
                            <asp:BoundColumn DataField="claimqty" HeaderText="Claim Qty" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Width="90"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Acctualqty" HeaderText="Actual Received Qty" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="60">
                            </asp:BoundColumn>
        ...
        <tr>
            <td>
                <span style="text-align: center">Store Clerk Kardexn>
            </td>
            <td>
