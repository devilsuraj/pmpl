<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptolirecive.aspx.vb" Inherits="KDMT.report_rptolirecive" %>
        ...
        <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 650px"
            ...
            <tr>
                <td class="text3" align="center" style="height: 22px">
                    <strong><span style="font-size: 11pt; color: black">OIL RECEIPT CONTROL REGISTER</span></strong>
                </td>
            </tr>
            <tr visible="false">
                <td>
    ...
    <table id="Table1" align="center" border="1" style="width: 100%" runat="server">
        ...
        <tr>
            <td align="center" colspan="5">
                <strong><span style="font-size: 14pt">Oil Receipt Control Register
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="oilname" ItemStyle-HorizontalAlign="left" HeaderText="Description of the Article"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ltrperbarrel" HeaderText="Ltr Per Barrel" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="center"
                                ItemStyle-Wrap="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="recbarrel" HeaderText="Liter Quantity" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false"></asp:BoundColumn>
                            <%--<asp:BoundColumn DataField="totalltr" HeaderText="Liter Quantity" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left" ItemStyle-Wrap="false"></asp:BoundColumn>--%>
                            <asp:BoundColumn DataField="perltrrate" HeaderText="Ltr Rate" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Total_Amount" HeaderText="Amount" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false"></asp:BoundColumn>
