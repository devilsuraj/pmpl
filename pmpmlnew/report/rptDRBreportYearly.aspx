<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptDRBreportYearly.aspx.vb" Inherits="KDMT.report_rptDRBreportYearly" %>
                    ...
                    <asp:DataGrid ID="grdstock" Style="align:center; valign:middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="total_qty_amt" HeaderText="Amount(Rs.)" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Width="120"></asp:BoundColumn>
                            <asp:BoundColumn DataField="StoreLedgerFolio" HeaderText="Store Ledger Folio" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="170">
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="vendor_name" HeaderText="Vendor Name" ItemStyle-HorizontalAlign="center"
                             ...
                             <asp:BoundColumn DataField="Drb_No" HeaderText="DRB No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="50">
                                </asp:BoundColumn>
                            <asp:BoundColumn DataField="drb_date" HeaderText="DRB Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="60">
                                </asp:BoundColumn>
                            <asp:BoundColumn DataField="bill_no" HeaderText="Bill No" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="80">
                                </asp:BoundColumn>
                            <asp:BoundColumn DataField="bill_date" HeaderText="Bill Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="60">
                                </asp:BoundColumn>    
                            ...
                            <asp:BoundColumn DataField="po_type" HeaderText="Order No" ItemStyle-HorizontalAlign="center"
                            ...
                            <asp:BoundColumn DataField="Rec_Date1" HeaderText="Rec Date" ItemStyle-HorizontalAlign="center"
                                HeaderStyle-HorizontalAlign="center" ItemStyle-Wrap="false" ItemStyle-Width="60">
                                </asp:BoundColumn>         
                           <%--Nilesh Code--%>
