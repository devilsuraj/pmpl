...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="excelissuereport.aspx.vb" Inherits="KDMT.excelissuereport" %>
...
<%  Dim con As New SqlConnection(System.Configuration.ConfigurationSettings.AppSettings("con"))
    ...
    Dim i As Integer
    Dim da As New SqlClient.SqlDataAdapter("VIEW_ITEMISSUE '" & fromdate & "','" & todate & "'", con)
