<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_minlavel_zero.aspx.vb" Inherits="KDMT.report_rpt_minlavel_zero" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px" colspan="4">
                <strong><span style="font-size: 11pt; color: black">Stock Level Item Balance Report &nbsp;</span></strong>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="4" align="center">
                <asp:DropDownList ID="drblevel" runat="server">
                    <asp:ListItem Text="All" Value="12"></asp:ListItem>
                    <asp:ListItem Text="Red List Items" Value="13"></asp:ListItem>
                    <asp:ListItem Text="Yellow List Items" Value="14"></asp:ListItem>                    
                    <asp:ListItem Text="Green List Items" Value="15"></asp:ListItem>                    
                </asp:DropDownList>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Stock Level Item Balance Report </span></strong>
            </td>
        </tr>
        <tr>
                    ...
                    <asp:DataGrid ID="grdstock"  runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="issue_item" HeaderText="Issue Qty" ItemStyle-HorizontalAlign="right"
                             ...
                             <%--    <asp:BoundColumn DataField="consunmption1" HeaderText="Average Consumtion Monthly From Last 3 Years" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>                                --%>
                                                                
                            <asp:BoundColumn DataField="balance" HeaderText="Balance" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                 <asp:BoundColumn DataField="color_id" HeaderText="color id" ItemStyle-HorizontalAlign="right" Visible="false"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn DataField="po" HeaderText="Pending PO NO/Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                  <asp:BoundColumn DataField="pen_qtys" HeaderText="Pending Qty" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
