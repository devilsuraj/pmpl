<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_po_status.aspx.vb" Inherits="KDMT.report_rpt_po_status" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px" colspan="4">
                <strong><span style="font-size: 11pt; color: black">PO Status Summery &nbsp;</span></strong>
            </td>
        </tr>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Spare Part - PO Status (Monthly) </span></strong>
            </td>
        </tr>
        <tr>
                    ...
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="Sr No.">
                             ...
                             <asp:BoundColumn DataField="months" HeaderText="MONTHS(2015)" HeaderStyle-HorizontalAlign="left"
                                ItemStyle-HorizontalAlign="left"></asp:BoundColumn>   
                            <asp:BoundColumn DataField="rc_po_qty" HeaderText="RC PO Qty" HeaderStyle-HorizontalAlign="left"
                                ItemStyle-HorizontalAlign="left"></asp:BoundColumn>                          
                            <asp:BoundColumn DataField="rc_po_item_qty" HeaderText="RC PO Item Qty" HeaderStyle-HorizontalAlign="left"
                                ItemStyle-HorizontalAlign="left"></asp:BoundColumn>                          
                            <asp:BoundColumn DataField="rc_po_amt" HeaderText="RC PO Amt(Rs.)" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn DataField="tc_po_qty" HeaderText="TC PO Qty" HeaderStyle-HorizontalAlign="left"
                                ItemStyle-HorizontalAlign="left"></asp:BoundColumn>       
                            <asp:BoundColumn DataField="tc_po_item_qty" HeaderText="TC PO Item Qty" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>                  
                           <asp:BoundColumn DataField="tc_po_amt" HeaderText="TC PO Amt(Rs.)" ItemStyle-HorizontalAlign="left"
                                ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn DataField="total_po_qty" HeaderText="TOTAL PO QTY" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>  
                                 <asp:BoundColumn DataField="total_po_item_qty" HeaderText="TOTAL PO Item QTY" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"></asp:BoundColumn>                  
                           <asp:BoundColumn DataField="total_po_amt" HeaderText="TOTAL PO Amt(Rs.)" ItemStyle-HorizontalAlign="left"
                                ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
