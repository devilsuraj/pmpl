<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptDeadStockSummary.aspx.vb" Inherits="KDMT.report_rptDeadStockSummary" %>
...
<html>
<head>
    <title>Dead Stock Summary Report</title>
...
<body class="body">
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td valign="top" align="center">
                <strong><span style="font-size: 16pt; color: black">Dead Stock Summary Report</span></strong>
            </td>
        </tr>
         <tr>
        <td>Type Of Items
    ...
    <div id="divcry" runat ="server" >
     ...
     <CR:CrystalReportViewer ID="crst_item_deadstock" runat="server" AutoDataBind="true" />
    </div>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Dead Stock Summary Report</span></strong>
            </td>
        </tr>
        <tr>
