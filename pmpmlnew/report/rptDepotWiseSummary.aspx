<%@ Page Language="VB" AutoEventWireup="false" EnableEventValidation="false" CodeFile="rptDepotWiseSummary.aspx.vb"
    Inherits="KDMT.report_rptDepotWiseSummary" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px">
                <strong><span style="font-size: 11pt; color: black">Depot Wise Summary Report &nbsp;</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Depot Wise Summary Report </span></strong>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="4">
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="itemname" HeaderText="Item" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <asp:BoundColumn DataField="quantity" HeaderText="Qunatity" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
       <asp:BoundColumn DataField="cont_name" HeaderText="Depot" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="left"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
                </div>
