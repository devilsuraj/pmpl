<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptoilissue.aspx.vb" Inherits="KDMT.rptoilissue" %>
    ...
    <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td class="text3" align="center" style="height: 22px">
                <strong><span style="font-size: 11pt; color: black">Oil Issue Report</span></strong>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4" style="height: 50px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" Width="224px">Oil Issue  Report</asp:Label>
            </td>
        </tr>
        <tr>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="worker_name" HeaderText="Worker Name"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="cont_name" HeaderText="Vendor"></asp:BoundColumn>
                        </Columns>
                    </asp:DataGrid>
