<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptABCreport.aspx.vb" Inherits="KDMT.rptissuereport" %>
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="Item_Name" FooterText="Total" HeaderText="Item Name"
                            ...
                            <asp:BoundColumn DataField="rack_no" HeaderText="LF No" ItemStyle-HorizontalAlign="left"
                            ...
                            <asp:BoundColumn DataField="Part_No" HeaderText="Part No" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Wrap="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Contotal" HeaderText="Consumption In Rupees" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="right"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ConPer" HeaderText=" Consumption In %" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="right"></asp:BoundColumn>
                            <asp:BoundColumn DataField="movingtype" HeaderText="Moving" ItemStyle-HorizontalAlign="center"
