...
Namespace KDMT
    Partial Class report_rpt_po_pending_items
        ...
        Protected Sub btnShowreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShowreport.Click
            ...
            Try
                ...
                lbltoyears.Text = ddlfinancecalendar2.SelectedDate
                fromdate = ddlfinancecalendar1.SelectedDate '  ddlfinancecalendar1.SelectedItem.Text
                todate = ddlfinancecalendar2.SelectedDate '  ddlfinancecalendar1.SelectedItem.Text
                'fromdate = year.ToString().Substring(0, 4)
                'todate = year.ToString().Substring(5, 4)

                lblfrom.Text = ddlfinancecalendar1.SelectedDate 'Format(Convert.ToDateTime(fromdate), "dd/MM/yy")
                ...
                'start nilesh Code'
                'BindGrid(grdstock, con, "[view_item_summary_yearly] '" & fromdate & "','" & todate & "','0','0'")
                BindGrid(grdstock, con, "[all_items_po_pending] '" & fromdate & "','" & todate & "','" & drpTypeOfItems.SelectedValue & "',0")
                'end nilesh code'
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                ddlfinancecalendar1.SelectedDate = Now.Date()
                ddlfinancecalendar2.SelectedDate = Now.Date()
        ...
        Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
            Try
                Dim fromdate As String
                Dim todate As String
                fromdate = ddlfinancecalendar1.SelectedDate ' ddlfinancecalendar.SelectedItem.Text
                todate = ddlfinancecalendar2.SelectedDate ' ddlfinancecalendar.SelectedItem.Text
                ' fromdate = year.ToString().Substring(0, 4)
                ' todate = year.ToString().Substring(5, 4)
                'lblfrom.Text = Format(Convert.ToDateTime(fromdate), "dd/MM/yy")
                'lbltodate.Text = Format(Convert.ToDateTime(todate), "dd/MM/yy")
                Dim dt As New DataTable
                dt = GetDatatTable("all_items_po_pending '" & fromdate & "' ,'" & todate & "','0','0'")
        ...
        Protected Sub grdstock_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grdstock.ItemDataBound
            ...
            'Select Case CType(e.Item.Cells(5).Text, String)
            '    Case Is = 0
            '        e.Item.Cells(5).BackColor = Drawing.Color.Red
            '        e.Item.Cells(5).ForeColor = Drawing.Color.White                     'Case Is = 10
