<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptoilrecieveregister.aspx.vb" Inherits="KDMT.report_rptoilrecieveregister" %>
...
<head>
    <title>Oil Receipt Register Report</title>
        ...
        <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
            ...
            <tr>
                <td class="text3" align="center" style="height: 22px">
                    <strong><span style="font-size: 11pt; color: black">Oil Receipt Register Report</span></strong>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                   Receipt From Date
                    ...
                    <asp:Button ID="crystal" runat="server" Text="Crystal Report" Visible="false"/>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Oil Receipt Register Report
                    ...
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                          <asp:TemplateColumn HeaderText="Sr No.">
                            ...
                            <asp:BoundColumn DataField="recno" HeaderText="Receipt No" HeaderStyle-HorizontalAlign="Center">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="oilrecdate" HeaderText="Date Of Receipt" HeaderStyle-HorizontalAlign="Center">
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="Oil_Name" HeaderText="Item" ItemStyle-HorizontalAlign="left"
                        ...
                        <%--    <asp:BoundColumn DataField="subrack_no" HeaderText="Bin No" ItemStyle-HorizontalAlign="left">
                            ...
                            <asp:BoundColumn DataField="quantity" HeaderText="Barrel Quantity" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                           <%-- <asp:BoundColumn DataField="count_in" HeaderText="Unit" ItemStyle-HorizontalAlign="left"
                            ...
                            <asp:BoundColumn DataField="rack_no" HeaderText="L/F No" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                            <asp:BoundColumn DataField="pono" HeaderText="PO No" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="podate" HeaderText="PO Date" ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"></asp:BoundColumn>
