<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptreceiptcontrolreport_YEAR.aspx.vb" Inherits="KDMT.report_rptreceiptcontrolreport_YEAR" %>
...
//-->
        ...
        <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 650px"
            ...
            <tr>
                <td class="text3" align="center" style="height: 22px">
                    <strong><span style="font-size: 11pt; color: black">RECEIPT CONTROL REGISTER YEARLY</span></strong>
                </td>
            </tr>
            <tr visible="false">
                <td>
            ...
            <tr>
                <td class="style1">
                    &nbsp;<span style="padding-left: 30px;">Part Type
            ...
            <tr>
                <td class="text3" align="center" style="height: 25px">
                 From Date
    ...
    <table id="Table1" align="center" border="1" style="width: 100%" runat="server">
        ...
        <tr>
            <td align="center">
                <strong><span style="font-size: 14pt">Receipt Control Register Yearly
                ...
                <div align="center">
                    <asp:DataGrid ID="grdstock" Style="align: center; valign: middle;" runat="server"
                        ...
                        <Columns>
                           ...
                           <asp:BoundColumn DataField="Rec_No" HeaderText="Rec No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>  
                           <asp:BoundColumn DataField="Rec_Date1" HeaderText="Rec Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="item_rate" HeaderText="Rate" HeaderStyle-HorizontalAlign="Left"
                            ...
                            <asp:BoundColumn DataField="total_qty" HeaderText="Quantity" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>
                                 <%--Nilesh Changes Starat--%>
                            <asp:BoundColumn DataField="vendor_name" HeaderText="Vendor Name" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>
                            <asp:BoundColumn DataField="bill_no" HeaderText="Bill No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>    
                            <asp:BoundColumn DataField="Bill_Date" HeaderText="Bill Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>  
                            <asp:BoundColumn DataField="challan_no" HeaderText="Challan No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>       
                            <asp:BoundColumn DataField="Challan_Date" HeaderText="Challan Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>   
                            <asp:BoundColumn DataField="po_no1" HeaderText="Order No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>  
                            <asp:BoundColumn DataField="PO_Date1" HeaderText="Order Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>
                           <%-- <asp:BoundColumn DataField="Rec_No" HeaderText="Rec No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn> --%> 
                             <%--<asp:BoundColumn DataField="Rec_Date1" HeaderText="Rec Date" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn> --%> 
                            <asp:BoundColumn DataField="store_id1" HeaderText="Serial No" ItemStyle-HorizontalAlign="right"
                                HeaderStyle-HorizontalAlign="right"></asp:BoundColumn>    
        ...
        <tr class="ctrl">
            <td align="center" rowspan="2" valign="top" style="height: 50px">
