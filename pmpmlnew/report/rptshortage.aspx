<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptshortage.aspx.vb" Inherits="KDMT.rptshortage" %>
...
//-->
        ...
        <table id="Table2" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
            ...
            <tr>
                <td colspan="4" class="text3" align="center" style="height: 22px">
                    <strong><span style="font-size: 11pt; color: black">Fuel Shortage Report</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddldepo" Visible="false" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <table id="Table1" align="center" cellspacing="0" cellpadding="0" border="1" style="width: 750px"
        ...
        <tr>
            <td align="center" colspan="4">
                <strong><span style="font-size: 14pt">Shortage Report </span></strong>
            </td>
        </tr>
        <tr>
