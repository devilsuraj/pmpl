    ...
    Partial Class rptfuelsummary
        ...
        Protected Sub btnshow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnshow.Click
            Try
                ...
                If bdpchallan_from.SelectedDate <> "#12:00:00 AM#" Then
                    lblchallan_date.Text = "IBC Date : " + bdpchallan_from.SelectedDate.ToString("dd/MM/yy")
                    challan_fromdate = bdpchallan_from.SelectedDate.ToString("MM/dd/yyyy")
                End If
                If bdpchallan_to.SelectedDate <> "#12:00:00 AM#" Then
                    lblchallan_todate.Text = "IBC ToDate : " + bdpchallan_to.SelectedDate.ToString("dd/MM/yy")
                    challan_todate = bdpchallan_to.SelectedDate.ToString("MM/dd/yyyy")
                End If


                BindGrid(grdstock, con, "view_fuel_summary_report '" & chq_fromdate.ToString() & "','" & chq_todate.ToString() & "', '" & challan_fromdate.ToString() & "','" & challan_todate.ToString() & "','" & txtfuel.Text & "','" & ddldepo.SelectedValue & "','" & ddldieselflag.SelectedValue & "'")
                ' End If
