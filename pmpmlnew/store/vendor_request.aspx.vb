...
Namespace KDMT
    Partial Class vendor_request
        ...
        Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnSubmit.Click
            ...
            cmd = New SqlCommand("Ins_requestindentmaster", con)
            cmd.CommandType = CommandType.StoredProcedure
            ...
            If Hid_Rec.Value <> "" Then
                ...
                For i = 0 To myarray.Length - 2
                    ...
                    cmd = New SqlCommand("Ins_requestindentdetail", con)
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.Add(New SqlParameter("@requestvendor_id ", maxid))
                    cmd.Parameters.Add(New SqlParameter("@item_code", str2))
                    cmd.Parameters.Add(New SqlParameter("@quantity", mainarray(3)))
                    con.Open()
                    cmd.ExecuteNonQuery()
                    Response.Write("<script>alert('Saved Successfuly');window.location.href='vendor_request.aspx'</script>")
                    con.Close()
