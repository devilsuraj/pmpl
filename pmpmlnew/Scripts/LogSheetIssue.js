						...
						function LogSheet2()
						{
							...
							function fn_Inner2_issue()
		                	{
								...
								var bus  = document.getElementById("txtRefNo").value;
								var qty = document.getElementById("txtqty").value;
								var balafterqty = document.getElementById("txtbalqty").value;
...
//								}
								...
								New_Cell_5.innerHTML = qty;
								New_Cell_6.innerHTML = balafterqty;
								New_Cell_7.innerHTML = bus;
...
//								document.getElementById("Hid_Rec").value = Recs +''+ IvechNo + '|' + IrouteNo + '|' + ItoLoc +  '|'  + IFromLoc +  '|' + refNo +  '|' + isReturnVal +  '^'
                                document.getElementById("Hid_Rec").value = Recs +''+ lfno + '|' + partno + '|' + itemname +  '|'  + balqty + '|' + qty + '|' + balafterqty + '|' + bus +    '^'
